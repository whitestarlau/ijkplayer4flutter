//#import "Ijkplayer4flutterPlugin.h"
//
//@implementation Ijkplayer4flutterPlugin
//+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
//  FlutterMethodChannel* channel = [FlutterMethodChannel
//      methodChannelWithName:@"ijkplayer4flutter"
//            binaryMessenger:[registrar messenger]];
//  Ijkplayer4flutterPlugin* instance = [[Ijkplayer4flutterPlugin alloc] init];
...
- (void)sendInitialized {
    NSLog(@"Ijk4flutter:sendInitialized");
...
@interface Ijkplayer4flutterPlugin ()
...
@implementation Ijkplayer4flutterPlugin
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    NSLog(@"Ijk4flutter:registerWithRegistrar");
    FlutterMethodChannel* channel =
    [FlutterMethodChannel methodChannelWithName:@"example.com/ijkplayer4flutter"
                                binaryMessenger:[registrar messenger]];
    Ijkplayer4flutterPlugin* instance = [[Ijkplayer4flutterPlugin alloc] initWithRegistrar:registrar];
    [registrar addMethodCallDelegate:instance channel:channel];
}
...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
    NSLog(@"Ijk4flutter:handleMethodCall,%@",call.method);
    if ([@"init" isEqualToString:call.method]) {
        ...
        NSLog(@"Ijk4flutter:dataSource,%@",dataSource);
        if (dataSource) {
            NSString* assetPath;
        ...
        FlutterEventChannel* eventChannel = [FlutterEventChannel
                                             eventChannelWithName:[NSString stringWithFormat:@"example.com/ijkplayer4flutter/videoEvents%lld",
                                                                   textureId]
